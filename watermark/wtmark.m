function [embimg,p, org]=wtmark(im,wt)
% wtmark function performs watermarking in Fraction DFT domain
...
global angles;
angles = [0.8, 0.5];
dct_img=blkproc(im,[8,8],@frft2d);% Fraction DFT of image using 8X8 block
...
angles = -[0.8, 0.5];
embimg=(uint8(blkproc(embimg,[8 8],@frft2d)));
